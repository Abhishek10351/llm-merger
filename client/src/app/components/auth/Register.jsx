...
// create a register component using react and tailwind css
// name, email, password, confirm password

import React, { useState } from 'react';
import { useRouter } from 'next/navigation';
// just plain react, no redux or react-query
        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            ...
            <form onSubmit={handleSubmit} className="bg-white p-6 rounded shadow-md w-full max-w-sm">
                <div className="mb-4">
                    ...
                    <input type="text" id="name" value={name} onChange={handleNameChange} required className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
                </div>
                <div className="mb-4">
                ...
                <div className="mb-4">
                    ...
                    <input type="password" id="confirm-password" value={confirmPassword} onChange={handleConfirmPasswordChange} required className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
                </div>
                ...
                {error && (
                    <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4" role="alert">
                        ...
                        <span onClick={() => setError
                            (null)} className="absolute top-0 bottom-0 right-0 px-4 py-3 cursor-pointer">
                ...
                <div className="mt-4">
                    <button onClick={() => router.push('/login')} className="text-blue-500 hover:text-blue-700 focus:outline-none">Already have an account? Login</button>
                </div>
            </form>
        </div>
